def call() {
  node {
    ...
    if (env.TAG_NAME != null) {
      stage('Docker Build') {
        sh """
          docker tag 633788536644.dkr.ecr.us-east-1.amazonaws.com/frontend:latest 633788536644.dkr.ecr.us-east-1.amazonaws.com/frontend:${TAG_NAME}
          ...
          docker push 633788536644.dkr.ecr.us-east-1.amazonaws.com/frontend:${TAG_NAME}
        """
      }
    }
